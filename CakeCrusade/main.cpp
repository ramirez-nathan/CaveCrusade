...
int main()
{
    ...
    try {
        enemies.push_back(make_unique<Soldier>(200.f, 50.f, 50.f, 0.15f, 10.0f));
        enemies.push_back(make_unique<Soldier>(200.f, 50.f, 50.f, 0.20f, 10.0f)); // give diff speeds to avoid complete overlapping
